    ...
    return (
        <div id="about" className="about">
            ...
            >
                ...
                <div className="about_rightimg"><img src={home} alt="" width="290px"/></div>

                        <h1>Gopi Mudmal</h1>
               <h4 className="number">Full Stack Web Developer</h4>
               <p className="number"> <TiLocation/> Raichur, Karnataka, India </p>    
               <p>
                <span>I am a passionate full stack developer skilled 
               in MERN Stack guided by Masai School </span>
                <br/>
               ...
               <p className="number"><FaPhoneAlt/> +91-6362325009</p>
               <p className="number"><IoMailSharp/> gopimudumal99@gmail.com</p> 
                <button className='home_getstarted pchange' style={{padding:"18px", width:"200px"}}>
                                    <a className='pchange' style={{ color: "teal", marginTop: "0px" }} target="_blank" href="https://drive.google.com/file/d/1hiKUAclYOMZ0R8QshPXOz5IGEeTmt6VZ/view?usp=sharing"> <p className='pchange' style={{marginTop:"-10px", fontWeight:"bold"}}>View My Resume</p> </a> 
               </button>
