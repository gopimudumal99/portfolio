            ...
            >
               ...
               <Grid item  xl={6} lg={6} md={6} sm={12} xs={12} className="projectdiv">
                   ...
                   <div className="container">
                      ...
                      <div className="gitlive">
                                <a href="https://github.com/gopimudumal99/faasos-masai-clone"
                                 target="_blank"
                                    >  <Button  className={classes.btn} variant="contained" style={{fontSize:"14px"}}>GitHub</Button>
                                </a> 
                            <div style={{width:"20px"}} />
                            <a href="https://faasos-masai-clone.herokuapp.com"
                            target="_blank"
                            >  
               ...
               <Grid item xl={6} lg={6} md={6} sm={12} xs={12} className="projectdiv">
                   <Paper>
                     <div className="container1">
                      ...
                      <h4>Faasos.com</h4>
                          <p>Faasos delivers all types of foods from breakfast to lunch to dinner all from your local restaurants even let you customize each order.
                          </p>
                          <p>
               ...
               <Grid item  xl={6} lg={6} md={6} sm={12} xs={12} className="projectdiv">
                   ...
                   <div className="container">
                      ...
                      <div className="gitlive">
                            ...
                            <div style={{width:"20px"}} />
                            <a href="https://ubuyclone.netlify.app/"
                            target="_blank"
                            >  <Button className={classes.btn}  variant="contained" style={{fontSize:"14px"}}>Live</Button>
                                </a> 
                            </div>
               ...
               <Grid item  xl={6} lg={6} md={6} sm={12} xs={12} className="projectdiv">
                   ...
                   <div className="container1">
                      <div className="content1">
                      <h4>Ubuy.com</h4>
                          <p>Ubuy is a popular cross border shopping e-commerce company that offers some of the best international brands which you can buy from the website.
                          </p>
                          <p>
                              Project duration: 4 days
                          </p>
